      ...
      content: [
        {
          ...
          contexts: [
            ...
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/01.png?raw=true',
        ...
        },
        {
          ...
          contexts: [
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/02.JPG?raw=true',
            ...
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/03.JPG?raw=true',
              content: '「ubuntuをインストール」を選択する。',
            },
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/04.JPG?raw=true',
              content: 'キーボードレイアウトはJapaneseに設定する。',
            },
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/05.JPG?raw=true',
              content: 'アップデートと他のソフトウェアは「通常のインストール」、その他のオプションは「グラフィックスとwi-fiハードウェアと追加のメディアフォーマットのサードパーティ製ソフトウェアをインストールする」を選択する。',
            },
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/06.JPG?raw=true',
              content: 'インストールの種類は「ディスクを削除してUbuntuをインストール」を選択する。',
            },
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/07.JPG?raw=true',
              content: '自分の住んでいる国を選択する。',
            },
            {
              type: 'info',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/08.JPG?raw=true',
              content: '自分の情報を入力する。',
            },
            {
              type: 'info',
      ...
      content: [
        {
          ...
          steps: [
            ...
            {
              type: 'command',
              image: 'https://github.com/yuga-school/serverkouchiku/blob/main/public/assets/09.JPG?raw=true',
